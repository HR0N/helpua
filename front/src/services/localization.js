...
let strings = new LocalizedStrings({
    ua: {
        ...
        main_yes: "Так",
        main_no: "Ні",
        if_cant_type_address: "Якщо ви не можете написати адресу - вкажіть у доп. коментарі, як з вами зв'язатися.",
        what_u_need: "Зробіть вибір у навігаційному меню вище, щоб отримати допомогу або допомогти комусь.",
        what_u_need2: "Нижче інформація яка може бути корисною.",
        /*todo: ......................................................... ......:::::: HEADER ::::::......     */
        main: "Головна",
        ...
        i_need_help_other_placeholder1: "Додатковий коментар. Опишіть будь ласка, яка допомога вам потрібна",
        ...
        i_can_help_other_placeholder1: "Додатковий коментар. Опишіть, будь ласка, чим ви хочете допомогти. Якщо ви не знаєте чим можете " +
    ...
    ru:{
        ...
        main_yes: "Да",
        main_no: "Нет",
        if_cant_type_address: "Если вы не можете написать адрес - укажите в доп. комментариях, как с вами связаться.",
        what_u_need: "Сделайте выбор в навигационном меню выше, чтобы получить помощь или помочь кому то.",
        what_u_need2: "Ниже информация которая может окказаться полезной.",
        /*todo: ......................................................... ......:::::: HEADER ::::::......     */
        main: "Главная",
        ...
        i_need_help_other_placeholder1: "Дополнительный комментарий. Опишите пожалуйста какая помощь вам требуется",
